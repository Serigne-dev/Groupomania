...
module.exports = (req, res, next) => {
  try {
    ...
    if (req.body.userId && req.body.userId !== userId) { // si la demande contient id utilisateur, comparaison avec celui extrait du token
      throw 'Invalid user ID';
    } else { // tout fonctionne, l'utilisateur est authentifié
